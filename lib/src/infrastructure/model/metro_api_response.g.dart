...
_MetroApiCityInfo _$MetroApiCityInfoFromJson(Map<String, dynamic> json) =>
    _MetroApiCityInfo(
...
Map<String, dynamic> _$MetroApiCityInfoToJson(_MetroApiCityInfo instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_MetroApiResponse _$MetroApiResponseFromJson(Map<String, dynamic> json) =>
    _MetroApiResponse(
      latitude: (json['latitude'] as num).toDouble(),
      longitude: (json['longitude'] as num).toDouble(),
...
Map<String, dynamic> _$MetroApiResponseToJson(_MetroApiResponse instance) =>
    <String, dynamic>{
      'latitude': instance.latitude,
      'longitude': instance.longitude,
